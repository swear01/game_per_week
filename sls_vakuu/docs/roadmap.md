...
## Backlog
- 自訂卡牌（第一張：colorless skill，練手 `OnPlay` + DynamicVars + 本地化）
- 自訂遺物 / 藥水 / 事件
- Godot .pck 資源製作（圖片、UI、本地化 json）— 需裝 Godot 4.5.x .NET
- BaseLib 或 ModSmith 框架選型深入
- 可選：STS2 Modding MCP 串接 AI 工作流
